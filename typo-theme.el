...
(let* ((fg "#111111")
       ...
       (headline-1 `(:foreground ,fg :weight semi-bold :height 1.4 :overline ,bg :family "Iosevka Slab"))
       (headline-2 `(:foreground ,fg :weight semi-bold :height 1.4 :overline ,bg :family "Iosevka Slab"))
