;;;###autoload
(defun phunculist/insert-header-comment ()
  ...
  (let ((header))
    ...
    (let* ((ender (phunculist/string-trim (or comment-end "")))
           (starter (phunculist/string-trim (or comment-start "#")))
           ...
           (indent-size (length
                         (phunculist/regex-replace
                          ...
                          (concat "\\(" (regexp-quote
                                  ...
                                  "\\)+$") "")))
           (outdent-size (length (phunculist/regex-replace
                                  ender
                                  (concat "^\\("
                                          (regexp-quote
                                           (char-to-string starter-tail))
