...
;;;###autoload
(defun phunculist/toggle-ruby-test ()
...
;;;###autoload
(defun phunculist/toggle-ruby-block-type ()
...
;;;###autoload
(defun phunculist/toggle-ruby-regex-type ()
      ...
      (if (string-match regex matched)
          (cond ((string= (substring matched 0 1) "/")
                ...
                ((string= (substring matched 0 1) "{")
                 ...
                 (let ((old_point (point)))
                   (insert (concat "/"
                                   (phunculist/regex-replace (substring matched 1 -1)
                                                             "/"
                                                             "\\\\/")
                                   "/"))
                ...
                ((string= (substring matched 0 3) "%r{")
                 ...
                 (let ((old_point (point)))
                   (insert (concat "/"
                                   (phunculist/regex-replace (substring matched 3 -1)
                                                             "/"
                                                             "\\\\/")
                                   "/"))
                   (goto-char (+ old_point 1)))))))))
...
;;;###autoload
(defun phunculist/toggle-ruby-string-and-symbol ()
...
;;;###autoload
(defun phunculist/toggle-ruby-hash-type ()
