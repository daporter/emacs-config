;;;###autoload
(defun phunculist/regex-replace (str regex replacement &optional fixedcase literal)
...
;;;###autoload
(defun phunculist/regex-replace-all (str
                                     regex
                                     replacement
                                     &optional
                                     fixedcase
  ...
  (if (string-match regex str)
      (concat (replace-match replacement
              ...
              (phunculist/regex-replace-all (substring str (match-end 0))
                                            regex
                                            replacement
                                            fixedcase
                                            literal))
