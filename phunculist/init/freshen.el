(defun phunculist/delete-out-of-date-bytecode (directory)
  ...
  (dolist (path-and-attributes (directory-files-and-attributes directory t))
    (let ((path       (car path-and-attributes))
      ...
      (cond ((string-prefix-p "." (file-name-nondirectory path))
            ...
            ((car attributes)
             (phunculist/delete-out-of-date-bytecode path))
...
(phunculist/delete-out-of-date-bytecode
 (expand-file-name "phunculist" user-emacs-directory))
